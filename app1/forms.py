...
class CalcForm(forms.Form):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.fields['dayE1'].widget = forms.HiddenInput()
    self.fields['nightE2'].widget = forms.HiddenInput()
    self.fields['neighbors'].widget = forms.HiddenInput()
    self.fields['us'].widget = forms.HiddenInput()
